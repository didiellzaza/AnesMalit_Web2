...
<head>
  ...
  <title>Anes Malit - Kontakt</title>
...
<body>
        ...
        <div class="container">
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav">
              ...
              <li class="nav-item active <?php if ($currentPage === 'kontakt.php') echo 'active'; ?>"><a class="nav-link" href="kontakt.php">Kontakt</a></li>
  ...
  <section class="section-margin">
    <div class="container">
      <div class="row">
        <!--Te dhenat e AnesMalit-->
        <div class="col-md-4 col-lg-3 mb-4 mb-md-0">
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-home"></i></span>
            <div class="media-body">
              <h3>Prishtine, Kosova</h3>
              <p>Lakrishte</p>
            </div>
          </div>
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3><a href="tel:44367916">+38344367916</a></h3>
              <p>E hene deri te premten 9:00-19:00</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-email"></i></span>
            <div class="media-body">
              <h3><a href="mailto:festinamjeku1@gmail.com">festinamjeku1@gmail.com</a></h3>
              <p>Na shkruani ne cdo kohe!</p>
            </div>
          </div>
        </div>
        <!--Mesazhi-->
        <div class="col-md-8 col-lg-9">
          <form class="row contact_form" action="" method="post" id="contactForm" onclick="return ValidateForm();">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <input type="email" class="form-control" id="email" name="email" placeholder="Shkruani adresen e juaj">
                <span class="error_msg"></span>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" id="subject" name="subject" placeholder="Shkruani temen">
                <span class="error_msg"></span>
              </div>
            </div>
            <div class="col-md-6">
  ...
  <script type="text/javascript">
    function sendEmail() {
      Email.send({
        ...
        Username: "festinamjeku1@gmail.com",
        Password: "25846089116D8A948FA8984E2169E4D56F7A",
        To: 'festinamjeku1@gmail.com',
  ...
  <script src="libs/jquery/functions.js"></script>
</body>
